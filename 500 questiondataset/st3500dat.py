...
def process_dataset(dataset):
    ...
    for record in dataset:
        # Debugging line to check the contents of 'record'
        print(record)  

        question = record["question"]
        entity = record.get("relevant_entity", None)  

        if entity and entity.lower() != "null":  # Skip if entity is null or None
...
def main():
    ...
    with open('labeled_pairs_dataset.json', 'w') as json_file:
